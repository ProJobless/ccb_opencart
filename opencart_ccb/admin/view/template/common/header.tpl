...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="tesoreria"><a class="top">Tesorer&iacute;a</a>
        <ul>
          <li><a href="<?php echo $cuenta_pedidos; ?>">Cuenta de pedidos</a></li>
          <li><a href="<?php echo $cuenta_gastos; ?>">Cuenta de gastos</a></li>
          <li><a href="<?php echo $cuentas_productores; ?>">Cuentas con productores</a></li>
        </ul>
      </li>
