    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-transaction">
	        <center>
          <table class="form" style="width: 40% !important;">
            <tr>
            ...
            <tr>
              <td><?php echo $entry_cuenta; ?></td>
              <td><select name="tipo_cuenta">
                  <option value="0" selected="selected"><?php echo $text_cuenta_pedidos; ?></option>
                  <option value="1"><?php echo $text_cuenta_gastos; ?></option>
                  <option value="2"><?php echo $text_comentario; ?></option>
                </select>
              </td>
            </tr>            
            <tr>
...
function addTransaction() {
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: 'description=' + encodeURIComponent($('#tab-transaction input[name=\'description\']').val()) + '&amount=' + encodeURIComponent($('#tab-transaction input[name=\'amount\']').val())+ '&tipo_cuenta=' + encodeURIComponent($('#tab-transaction select[name=\'tipo_cuenta\']').val()),
		beforeSend: function() {
		...
		success: function(html) {
			...
			$('#tab-transaction select[name=\'tipo_cuenta\']').val('');
		}
	});
}
//--></script> 
