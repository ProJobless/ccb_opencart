...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		$this->data['text_latest_10_orders'] = 'Pedidos pendientes';
		...
		$this->data['total_pending_sales'] = $this->currency->format($this->model_sale_order->getTotalPendingSales(), $this->config->get('config_currency'));
