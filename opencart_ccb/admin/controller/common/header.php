...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['cuenta_pedidos'] = $this->url->link('tesoreria/cuenta_pedidos', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['cuenta_gastos'] = $this->url->link('tesoreria/cuenta_gastos', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['cuentas_productores'] = $this->url->link('tesoreria/cuentas_productores', 'token=' . $this->session->data['token'], 'SSL');
