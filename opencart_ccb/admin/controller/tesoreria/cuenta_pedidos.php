<?php
class Controllertesoreriacuentapedidos extends Controller { 
	private $error = array();

	public function index() {
		$this->load->language('tesoreria/cuenta_pedidos');

		$this->document->setTitle($this->language->get('heading_title'));
		 
		$this->load->model('tesoreria/cuenta_pedidos');
	...
	private function getHome() {
		...
		$this->data['breadcrumbs'] = array();
 		...
 		$this->data['breadcrumbs'][] = array(
     		'text'      => $this->language->get('heading_title'),
				//'href'      => $this->url->link('tesoreria/cuenta_pedidos', 'token=' . $this->session->data['token'] . $url, 'SSL'),
    		'separator' => ' :: '
 		);
		...
		//Declaro si hay error warning				
 		...
 		//Saco la informacion del balance total
		$balance_total = $this->model_tesoreria_cuenta_pedidos->getBalanceCuentaPedidos();
		$currency_info = $this->model_localisation_currency->getCurrencyByCode($this->config->get('config_currency'));
		$currency_code = $currency_info['code'];
		$currency_value = $currency_info['value'];
		//echo "JEJEJE-->".$currency_code."-".$currency_value;
		$this->data['balance_total'] = $this->currency->format($balance_total, $currency_code, $currency_value);
		...
		//Saco la informacion de los saldos
		$results = $this->model_tesoreria_cuenta_pedidos->getListaSaldosCuentaPedidos();
		
		$this->data['cliente'] = $this->language->get('cliente');
		$this->data['saldo'] = $this->language->get('saldo');
		$this->data['column_action'] = $this->language->get('column_action');		
    ...
    foreach ($results as $result) {
			...
			$this->data['saldos'][] = array(
				...
				'id'  				=> $customer_id,
				'saldo'    		=> $this->currency->format($result['saldo'], $currency_code, $currency_value),
				'action'      => $action
			);
		}		
