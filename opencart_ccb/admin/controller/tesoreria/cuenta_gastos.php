<?php
class Controllertesoreriacuentagastos extends Controller { 
	private $error = array();

	public function index() {
		$this->load->language('tesoreria/cuenta_gastos');

		$this->document->setTitle($this->language->get('heading_title'));
		 
		$this->load->model('tesoreria/cuenta_gastos');
    ...
    foreach ($results as $result) {
		...
		$this->template = 'tesoreria/cuenta_gastos.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getHome() {
		...
		$this->data['breadcrumbs'] = array();
 		...
 		$this->data['breadcrumbs'][] = array(
     		'text'      => $this->language->get('heading_title'),
				//'href'      => $this->url->link('tesoreria/cuenta_gastos', 'token=' . $this->session->data['token'] . $url, 'SSL'),
    		'separator' => ' :: '
 		);
		...
		$balance_total = $this->model_tesoreria_cuenta_gastos->getBalanceCuentagastos();
		...
		$results = $this->model_tesoreria_cuenta_gastos->getListaSaldosCuentagastos();
