...
class ControllerSaleCustomer extends Controller { 
	...
	public function approve() {
  	...
  	private function getForm() {
		...
		$this->data['entry_cuenta'] = $this->language->get('entry_cuenta');
		$this->data['text_ingreso_pedidos'] = $this->language->get('text_ingreso_pedidos');
		$this->data['text_ingreso_ajuste'] = $this->language->get('text_ingreso_ajuste');
		$this->data['text_ingreso_gastos'] = $this->language->get('text_ingreso_gastos');
		$this->data['text_descuento_pedidos'] = $this->language->get('text_descuento_pedidos');
		$this->data['text_descuento_ajuste'] = $this->language->get('text_descuento_ajuste');
		$this->data['text_descuento_gastos'] = $this->language->get('text_descuento_gastos');
 		$this->data['text_cuenta_pedidos'] = $this->language->get('text_cuenta_pedidos');
		$this->data['text_cuenta_gastos'] = $this->language->get('text_cuenta_gastos');
		$this->data['text_ajustes'] = $this->language->get('text_ajustes');
		$this->data['text_comentario'] = $this->language->get('text_comentario');
	...
	public function transaction() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->user->hasPermission('modify', 'sale/customer')) { 
			$this->model_sale_customer->addTransaction($this->request->get['customer_id'], $this->request->post['description'], $this->request->post['amount'], $this->request->post['tipo_cuenta']);
		...
		$this->data['text_balance_pedidos'] = $this->language->get('text_balance_pedidos');
		$this->data['text_balance_gastos'] = $this->language->get('text_balance_gastos');
		$this->data['text_ingreso_pedidos'] = $this->language->get('text_ingreso_pedidos');
		$this->data['text_descuento_pedidos'] = $this->language->get('text_descuento_pedidos');
		$this->data['text_ingreso_gastos'] = $this->language->get('text_ingreso_gastos');
		$this->data['text_descuento_gastos'] = $this->language->get('text_descuento_gastos');
		...
		$this->data['column_cuenta'] = $this->language->get('column_cuenta');
		...
		$this->data['balance_pedidos'] = $this->currency->format($this->model_sale_customer->getTransactionPedidosTotal($this->request->get['customer_id']), $this->config->get('config_currency'));
		$this->data['balance_gastos'] = $this->currency->format($this->model_sale_customer->getTransactionGastosTotal($this->request->get['customer_id']), $this->config->get('config_currency'));
