...
$_['text_description'] = 'Este vale de regalo será enviado al destinatario después de que tu pedido haya sido pagado.';
$_['text_agree']       = 'Entiendo que el vale regalo es no reembolsable.';
$_['text_message']     = '<p>Gracias por comprar un vale regalo! Una vez que hayas completado tu pedido se enviará el vale regalo al destinatario por e-mail junto a los detalles de como utilizarlo.</p>';
