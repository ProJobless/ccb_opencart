...
class ControllerAccountTransaction extends Controller {
	public function index() {
		...
		$this->data['column_tipo_cuenta'] = $this->language->get('column_tipo_cuenta');
		$this->data['column_amount'] = sprintf($this->language->get('column_amount'), $this->config->get('config_currency'));
		
		$this->data['text_total'] = $this->language->get('text_total');
		$this->data['text_total_pedidos'] = $this->language->get('text_total_pedidos');
		$this->data['text_total_gastos'] = $this->language->get('text_total_gastos');
